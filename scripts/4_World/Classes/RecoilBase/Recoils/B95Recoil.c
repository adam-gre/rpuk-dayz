class B95Recoil: RecoilBase
{
	override void Init()
	{
		...
		m_MouseOffsetDistance = 1.9;//how far should the mouse travel
		m_MouseOffsetRelativeTime = 0.625;//[0..1] a time it takes to move the mouse the required distance relative to the reload time of the weapon(firing mode)

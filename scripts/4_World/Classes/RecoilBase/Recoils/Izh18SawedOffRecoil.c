class Izh18SawedOffRecoil: RecoilBase
{
	override void Init()
	{
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(0.75,1); point_1[1] = 2.75; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(-0.5,0.5); point_2[1] = 3; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(-0.75,-1); point_3[1] = 2.5; point_3[2] = 0;

class Mp5kRecoil: RecoilBase
{
	...
	{		
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(0.5,1); point_1[1] = 1; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(-0.75,0.75); point_2[1] = 1.5; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(-0.5,-1); point_3[1] = 1; point_3[2] = 0;
		point_4[0] = Math.RandomFloatInclusive(-0.25,-0.1); point_4[1] = 0.5; point_4[2] = 0;

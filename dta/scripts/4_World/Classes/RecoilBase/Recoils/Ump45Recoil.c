class Ump45Recoil: RecoilBase
{
	override void Init()
	{
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(0.5,1); point_1[1] = 0.8; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(-1,1); point_2[1] = 1; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(-0.75,-1.75); point_3[1] = 1; point_3[2] = 0;
		point_4[0] = Math.RandomFloatInclusive(-0.5,-0.1); point_4[1] = 0.6; point_4[2] = 0;

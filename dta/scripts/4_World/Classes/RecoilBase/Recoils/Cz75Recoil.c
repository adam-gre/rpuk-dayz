class Cz75Recoil: RecoilBase
{
	override void Init()
	{
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(1.5,3); point_1[1] = 3; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(-1,1); point_2[1] = 4; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(-2,-4); point_3[1] = 2; point_3[2] = 0;
		point_4[0] = Math.RandomFloatInclusive(-0.6,-0.2); point_4[1] = 1; point_4[2] = 0;

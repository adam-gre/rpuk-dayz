class CraftFishingRod extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_CraftFishingRod0";
		...
		//InsertIngredient(0,"ImprovisedRope");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ImprovisedFishingRod");//add results here
